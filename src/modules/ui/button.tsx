...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none active:scale-[0.98]',
  {
    variants: {
      variant: {
        default: 'bg-accent text-accent-foreground hover:shadow-[0_0_20px_hsl(var(--accent)/0.5)] hover:brightness-110',
        outline: 'border border-border-strong bg-white/5 hover:bg-white/10 hover:border-glow/50',
