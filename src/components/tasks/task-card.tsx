  ...
  return (
    ...
    >
      <TiltCard className="h-full">
        <Card className="p-5 flex flex-col justify-between h-full transition-colors duration-300 group-hover:border-glow/40 group-hover:shadow-[0_0_30px_hsl(var(--glow)/0.15)]">
          <div>
